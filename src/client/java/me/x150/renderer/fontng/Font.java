...
public class Font extends RefWatcher {
	...
	/**
	 * Returns the scaled ascent of the font (distance from baseline to top of tallest glyph).
	 *
	 * @return The ascent of the font
	 */
	public float ascent() {
		return cachedAscender / 64f;
	}
	...
	private void applySize() {
		...
		cachedAscender = freetypeFont.size().metrics().ascender();
	}
