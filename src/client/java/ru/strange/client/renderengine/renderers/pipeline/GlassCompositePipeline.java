...
public class GlassCompositePipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("strange", "pipeline/glass_composite");
    private static final Identifier SHADER = Identifier.of("strange", "core/glass_composite");
    ...
    private void ensureInitialized() {
        ...
        this.dummyVertexBuffer = RenderSystem.getDevice().createBuffer(
                () -> "strange:glass_composite_dummy_vertex",
    ...
    public void composite(GpuTextureView targetView, GpuTextureView sceneView,
                          ...
                          float edgeGlowIntensity, int glowColor, float glowIntensity) {

        ensureInitialized();

        prepareUniformData(width, height, saturation, reflect, tintColor, tintIntensity, edgeGlowIntensity, glowColor, glowIntensity);

        int size = dataBuffer.remaining();
        if (uniformBuffer == null || uniformBuffer.size() < size) {
            if (uniformBuffer != null) uniformBuffer.close();
            uniformBuffer = RenderSystem.getDevice().createBuffer(
                    () -> "strange:glass_composite_uniform",
        ...
        try (RenderPass renderPass = encoder.createRenderPass(
            ...
            renderPass.bindSampler("BlurSampler", blurView);
