...
public final class PipelineRegistry {
    ...
    private static VertexFormatElement CENTER_UV_ELEMENT;
    ...
    public static void init() {
        ...
        CENTER_UV_ELEMENT = VertexFormatElement.register(getNextVFId(), 0, VertexFormatElement.Type.FLOAT, VertexFormatElement.Usage.UV, 2);
