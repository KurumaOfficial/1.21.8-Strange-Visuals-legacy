...
public class GuiRenderCategory extends GuiScreen {
    public static void renderCategory(DrawContext ctx) {
        ...
        RenderUtil.Round.draw(ctx, x + 7, y + 30, 195, 12, 4, theme ? RenderUtil.ColorUtil.replAlpha(RenderUtil.ColorUtil.getMainColor(1,1), 127) : themeTwo ? RenderUtil.ColorUtil.replAlpha(RenderUtil.ColorUtil.getMainColor(1,1), 160) : RenderUtil.ColorUtil.getMainColor(1,1));
        float xGo = 0;
