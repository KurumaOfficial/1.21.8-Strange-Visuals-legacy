...
public class PlayerParticles extends Module {
    ...
    public void onRender(EventRender3D event) {
        ...
        try {
            ParticleUtil.renderParticles(matrix, renderVertexConsumers, cameraPos, targetParticles);
            ParticleUtil.renderParticles(matrix, renderVertexConsumers, cameraPos, flameParticles);
