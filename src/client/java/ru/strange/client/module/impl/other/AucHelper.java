...
public class AucHelper extends Module {
    ...
    private static boolean loggedMissingTranslationResource;
    private static boolean loggedTranslationLoadFailure;
    ...
    private static Map<String, String> getRuTranslations() {
        ...
        try {
            ...
            if (resource.isEmpty()) {
                if (!loggedMissingTranslationResource) {
                    loggedMissingTranslationResource = true;
                    Strange.LOGGER.debug("AucHelper could not find minecraft:lang/ru_ru.json; using runtime item names");
                }
            ...
            if (!loggedTranslationLoadFailure) {
                loggedTranslationLoadFailure = true;
                Strange.LOGGER.warn("AucHelper failed to load Russian translation table for /ah search fallback", exception);
            }
            return ruTranslations;
        }
        return ruTranslations;
